...
layout.register_submap({
	...
	entries = {
		...
		{ key = "equal", desc = "Scrolling: widen the active column", action = hl.dsp.layout("colresize +0.1"), stay = true, repeating = true },
		{ key = "minus", desc = "Scrolling: narrow the active column", action = hl.dsp.layout("colresize -0.1"), stay = true, repeating = true },
	},
})
